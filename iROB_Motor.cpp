...
void iROB_Motor ::Motor_DutyCycle_LF(int16_t DutyCycle_LF) {
  ...
  ledcWrite(0, (DutyCycle_LF > 0) ? DutyCycle_LF : 0);
  ledcWrite(1, (DutyCycle_LF >= 0) ? 0 : -DutyCycle_LF);
}
void iROB_Motor ::Motor_DutyCycle_LB(int16_t DutyCycle_LB) {
  ...
  ledcWrite(2, (DutyCycle_LB > 0) ? DutyCycle_LB : 0);
  ledcWrite(3, (DutyCycle_LB >= 0) ? 0 : -DutyCycle_LB);
}
void iROB_Motor ::Motor_DutyCycle_RF(int16_t DutyCycle_RF) {
  ...
  ledcWrite(4, (DutyCycle_RF > 0) ? DutyCycle_RF : 0);
  ledcWrite(5, (DutyCycle_RF >= 0) ? 0 : -DutyCycle_RF);
}
void iROB_Motor ::Motor_DutyCycle_RB(int16_t DutyCycle_RB) {
  ...
  ledcWrite(6, (DutyCycle_RB > 0) ? DutyCycle_RB : 0);
  ledcWrite(7, (DutyCycle_RB >= 0) ? 0 : -DutyCycle_RB);
}
